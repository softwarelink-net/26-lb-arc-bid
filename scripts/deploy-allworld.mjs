...
/**
 * Upload dist/ to:
 *   1) R2 26-lb-arc-bid-assets  (project bucket)
 *   2) R2 allworld-sites/26-lb-arc-bid/  (shared Allworld host)
...
const siteId = process.argv[2] || '26-lb-arc-bid'
const projectBucket = '26-lb-arc-bid-assets'
